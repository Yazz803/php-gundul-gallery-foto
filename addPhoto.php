                ...
                <div style="max-width: 500px;margin:auto">
                    ...
                    <form class="user" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="text" name="JudulFoto" class="form-control form-control-user" placeholder="Enter Title Image...">
                        </div>
                        <div class="form-group">
                            <input type="text" name="DeskripsiFoto" class="form-control form-control-user" placeholder="Enter Description Image...">
                        </div>
